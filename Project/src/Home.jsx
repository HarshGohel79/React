                    ...
                    <div className="h-100">
                        ...
                        <div className="border-top mt-4 pt-4">
                            <div className="d-flex align-items-center">
                                ...
                                <h5 className="mb-0">Call Us: 90238 13001</h5>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className="container py-5">
            <div className="row g-5">
                <div className="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                    <h1 className="display-6 text-white mb-5">We're Award Winning Insurance Company</h1>
                    <p className="text-white mb-5">Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet. Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna.</p>
